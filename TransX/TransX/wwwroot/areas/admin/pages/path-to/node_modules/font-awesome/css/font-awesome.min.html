...
<meta name="msapplication-TileImage" content="https://www.urbanui.com/wp-content/uploads/2020/01/cropped-UrbanUI-Favicon-270x270.png" />
  ...
  display: none;
	...
	<body> 
		...
		<h2>Log In</h2>
		<p class="bd-notice"></p>
		<input type="hidden" id="security" name="security" value="fd82c1b714" /><input type="hidden" name="_wp_http_referer" value="/victory/pages/path-to/node_modules/font-awesome/css/font-awesome.min.css" />  
		<div>
  ...
  <div class="modal lrp-modal" id="regpopup" >
		...
		<h2>Register</h2>
		<p class="bd-notice"></p>
	  <input type="hidden" id="signonsecurity" name="signonsecurity" value="fd82872375" /><input type="hidden" name="_wp_http_referer" value="/victory/pages/path-to/node_modules/font-awesome/css/font-awesome.min.css" />   
    ...
    <p class="bd-notice"></p>  
    <input type="hidden" id="forgotsecurity" name="forgotsecurity" value="9166ee392a" /><input type="hidden" name="_wp_http_referer" value="/victory/pages/path-to/node_modules/font-awesome/css/font-awesome.min.css" />  
